...
/*   Updated: 2021/11/15 16:48:15 by                  ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	signal_c(int sig)
{
	(void)sig;
	write(2, "\n", 1);
//	rl_replace_line("", 0); /**подменяет значение(приветствие) строки*/
	rl_on_new_line();
	rl_redisplay();
	g_status = 130;/**глобальная переменная где храниться int состояния*/
}
